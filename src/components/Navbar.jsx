...
const Navbar = () => {
  ...
  return (
    <div
      name="navbar"
      className="fixed w-full h-[80px] mb-4 bg-[#0a192f] flex justify-between items-center pr-4 pl-0 text-gray-300"
    >
      <div className="">
      ...
      <ul
        className={
          !nav
            ? "hidden"
            : "w-full absolute h-screen left-0 top-0 bg-[#0a192f] flex flex-col justify-center items-center"
        }
      >
      ...
      <div className="hidden lg:flex top-[35%] left-0 flex-col fixed">
        <ul>
          <li className="flex justify-between items-center w-[160px] h-[60px] bg-blue-400 text-gray-200 ml-[-100px] hover:ml-[-10px] duration-300">
            <a
              href="https://www.linkedin.com/in/elham-soltani-b093b8248/"
              target="blank"
          ...
          <li className="flex justify-between items-center w-[160px] h-[60px] bg-[#333] text-gray-200 ml-[-100px] hover:ml-[-10px] duration-300">
            <a
              href="https://github.com/elham3oltani"
              target="blank"
              className="flex justify-between items-center w-full text-gray-300"
            >
